...
{
	XIpiPsu_WriteMessage(&IpiInst, XIPI_TARGETS[msg_buff->target], (void*)msg_buff, IPI_MSG_SIZE, XIPIPSU_BUF_TYPE_MSG);
	XIpiPsu_TriggerIpi(&IpiInst, XIPI_TARGETS[msg_buff->target]);
}
...
{
	XIpiPsu_WriteMessage(&IpiInst, XIPI_TARGETS[msg_buff->target], (void*)msg_buff, IPI_MSG_SIZE, XIPIPSU_BUF_TYPE_RESP);
	XIpiPsu_TriggerIpi(&IpiInst, XIPI_TARGETS[msg_buff->target]);
}
